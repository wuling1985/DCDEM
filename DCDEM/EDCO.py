...
if __name__ == "__main__":
    # infile = "Input/dynamic/enron_t1.txt"

    for t in range(1,9):
        infile = "Input/artificial network/sizes/S{}.txt".format(t)
        # optmod = 0
        # optepscon = 0
        # optu = 0
        # optCS = -1
        for u in [5]:
            for epson in [0.3]:
                ...
                #     optCS = CS
        # writetofile(CS,outputfile)
        # print("best mod:{}-{}-{}-{}".format(t,optmod,optepscon,optu))